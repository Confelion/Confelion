export const STORE_SETTINGS = {
  ...
  announcement: "India's Own All BLACK Premium Fashion Label",
  hero_headline: 'Rooted in culture, crafted with black.',
  hero_subtext: 'Exclusive apparel engineered in pure all-black silhouettes.',
  hero_button_text: 'Shop Now',
  hero_button_link: '/products',
  hero_image_pc: 'https://www.kaalvaish.in/cdn/shop/files/Kaalvaish_Hero_Banner_PC_1.png?v=1786518719&width=3840',
  hero_image_mobile: 'https://www.kaalvaish.in/cdn/shop/files/Kaalvaish_Hero_Banner_MOBILE.png?v=1786518421&width=3840',
  editorial_banner: 'https://www.kaalvaish.in/cdn/shop/files/ChatGPT_Image_May_27_2026_02_24_02_PM.png?v=1780306111&width=3840',
  editorial_title: 'ONLY FEAR GOD',
  editorial_subtitle: 'Command respect through silence.',
  logo_url: '/images/confelion-logo.png',
  footer_about: "CONFELION is India's dedicated all-black luxury fashion label. Every drop is crafted in limited numbers with heavyweight silhouettes and architectural tailoring from our Poonchh fulfillment hub.",
  shipping_info: 'Packed & dispatched within 24 hours from Poonchh Hub 284304. Free express delivery on orders above ₹999.',
  exchange_policy: '3-day doorstep size exchange policy across India via Delhivery.',
  luxury_box_threshold: 3000,
  cod_enabled: true,
  cod_fee: 99,
  partial_payment_enabled: true,
  partial_advance_amount: 300,
  footer_trust_1_title: 'FAST DISPATCH',
  footer_trust_1_text: 'Dispatched in 24 hours. Free express shipping.',
  footer_trust_2_title: '3-DAY EXCHANGE',
  footer_trust_2_text: 'Hassle-free size exchange guarantee.',
  footer_trust_3_title: 'LUXURY PACKAGING',
  footer_trust_3_text: 'Rigid magnetic box on orders above ₹3,000.',
...
export const CUSTOMERS_DATA = [
  {
    ...
    status: 'VIP',
    address: 'Flat 402, Sea Crest Towers, Bandra West, Mumbai 400050'
  },
  {
    id: 'cust-102',
    name: 'Rohan Sharma',
  ...
  },
  {
    ...
    status: 'VIP',
    address: 'B-44, Greater Kailash 1, New Delhi 110048'
  },
  {
    id: 'cust-104',
    name: 'Pooja Nair',
    ...
    status: 'Active',
    address: 'Green Valley Apts, Marine Drive, Kochi 682031'
  },
  {
    id: 'cust-105',
    ...
    total_orders: 5,
    total_spent: 17485,
    last_order_date: '2026-09-07',
    joined_date: '2026-03-02',
    status: 'VIP',
    address: 'Penthouse 12, Sky Lounge, Koregaon Park, Pune 411001'
  },
  {
    id: 'cust-106',
    name: 'Ananya Roy',
    ...
    status: 'Active',
    address: '14/2 Ballygunge Circular Rd, Kolkata 700019'
  },
  {
    id: 'cust-107',
    name: 'Vikram Mehta',
    ...
    status: 'Active',
    address: '702 Shivalik Heights, Bodakdev, Ahmedabad 380054'
  },
  {
    id: 'cust-108',
    name: 'Devansh Roy',
