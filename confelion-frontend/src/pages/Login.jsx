...
export default function Login() {
  ...
  const handleSuccessfulAuth = (role, authEmail = email) => {
    ...
    const isAdminAuth = role === 'admin' || clean === 'confelion@gmail.com' || clean === 'admin.confelion@gmail.com' || clean === 'admin@confelion.com';
  ...
  const handleEmailLogin = async (e) => {
    ...
    if (!emailRegex.test(cleanEmail)) {
      return setError('Please enter a valid email format (e.g. name@gmail.com).');
    }
    if (!password) {
    ...
    if (err) {
      return setError(err.message || 'Authentication failed. Please verify credentials or create an account.');
    }
